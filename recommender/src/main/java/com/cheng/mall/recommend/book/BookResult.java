...
/**
 * 
 * @author linkc 对指定数量的结果人工比较 为得到差异化结果， 分别取四个算法： userEuclidean， itemEuclidean，
 *         userEuclideanNoPref， itemEuclideanNoPref， 对推荐结果人工比较
 */
public class BookResult {
	...
	public static void main(String[] args) throws TasteException, IOException {
		...
		// RecommenderBuilder rb3 =
		// BookEvaluator.userEuclideanNoPref(dataModel);
